...
CONFIG.Width  = 1220;       -- 游戏图形窗口宽, 设置为0则由系统自动适应
CONFIG.Height = 700;      -- 游戏图形窗口高

--CONFIG.Width  = 1800;       -- 游戏图形窗口宽, 设置为0则由系统自动适应
--CONFIG.Height = 900;      -- 游戏图形窗口高
...
CONFIG.KeyRepeat=1       -- 是否激活键盘重复 0 不激活，只在走路菜单时键盘重复，1激活，包括对话的所有时候键盘均重复
...
CONFIG.Traditional = 1     -- 以繁體顯示簡體字（僅影響顯示，不改動腳本或存檔）
...
CONFIG.CEventPath = CONFIG.ScriptPath.."script/";
...
--贴图大小，百分比，100表示正常大小  --100时为远景，200时为近景
CONFIG.Zoom = 100;
